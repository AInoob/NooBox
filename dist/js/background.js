...
NooBox.Options.defaultValues = [['userId', (Math.random().toString(36) + '00000000000000000').slice(2, 19)], ['imageSearch', true], ['shorcut', false], ['unitsConverter', false], ['crypter', true], ['webmaster', true], ['general', true], ['background', false], ['imageSearchUrl_google', true], ['imageSearchUrl_baidu', true], ['imageSearchUrl_tineye', true], ['imageSearchUrl_bing', true], ['imageSearchUrl_yandex', true], ['imageSearchUrl_saucenao', false], ['imageSearchUrl_iqdb', false], ['imageSearchUrl_sogou', false], ['imageSearchUrl_ascii2d', false], ['extractImages', true], ['screenshotSearch', true], ['videoControl', false], ['autoRefresh', true], ['displayOrder', []], ['checkUpdate', true], ['lastUpdateCheck', 0], ['updateHistory', []], ['history', true]];

NooBox.Options.constantValues = [['displayList', ['imageSearch', 'autoRefresh', 'videoControl', 'checkUpdate']], ['version', '0.9.4.5']];
...
NooBox.Image.imageSearchByUrl = function (cursor, result, engines) {
...
NooBox.Image.imageSearchByUrlEngine = function (engine, result, cursor) {
  var ajaxRequest = NooBox.Image.generateAjaxRequest(engine, result);
  var body = {};
  ...
  xhr.send(ajaxRequest.data ? Object.keys(ajaxRequest.data).map(function (k) {
    return encodeURIComponent(k) + '=' + encodeURIComponent(ajaxRequest.data[k]);
  }).join('&') : null);
};

NooBox.Image.generateAjaxRequest = function (engine, result) {
  var imageUrl = result.uploadedURL || result.imageUrl;
...
NooBox.Image.fetchFunctions.ascii2d = function (cursor, result, data) {
  try {
    data = data.replace(/<img/g, "<nooboximage");
    var page = $(data);
    var websites = [];
    var relatedWebsites = [];
    var websiteList = $(page.find('.item-box')) || [];
    for (var i = 1; i < websiteList.length; i++) {
      var website = {
      ...
      var temp = websiteList[i];
      temp = $(temp);
      var _x7 = $(temp).find('.detail-box a')[0] || {};
      website.title = _x7.innerText;
      website.link = _x7.href;
...
var hide = __webpack_require__(136);
...
var _Symbol = __webpack_require__(126).Symbol;
...
if (__webpack_require__(130)) {
  ...
  var ctx = __webpack_require__(142);
  var anInstance = __webpack_require__(163);
...
var $export = __webpack_require__(124);
var shared = __webpack_require__(173)('metadata');
...
var UNSCOPABLES = __webpack_require__(129)('unscopables');
var ArrayProto = Array.prototype;
if (ArrayProto[UNSCOPABLES] == undefined) __webpack_require__(136)(ArrayProto, UNSCOPABLES, {});
...
var $keys = __webpack_require__(216);
var hiddenKeys = __webpack_require__(190).concat('length', 'prototype');
...
var global = __webpack_require__(126);
var dP = __webpack_require__(131);
var DESCRIPTORS = __webpack_require__(130);
...
var defined = __webpack_require__(147);
var fails = __webpack_require__(127);
var spaces = __webpack_require__(193);
var space = '[' + spaces + ']';
var non = '\u200B\x85';
...
var isObject = __webpack_require__(128);
var cof = __webpack_require__(143);
var MATCH = __webpack_require__(129)('match');
module.exports = function (it) {
  var isRegExp;
...
var redefine = __webpack_require__(137);
var redefineAll = __webpack_require__(165);
var meta = __webpack_require__(153);
...
module.exports = __webpack_require__(157) || !__webpack_require__(127)(function () {
  var K = Math.random();
  // In FF throws only define methods
  // eslint-disable-next-line no-undef, no-useless-call
  __defineSetter__.call(null, K, function () {/* empty */});
  delete __webpack_require__(126)[K];
});
...
module.exports = {
  ...
  function (test, buggy, set) {
    try {
      set = __webpack_require__(142)(Function.call, __webpack_require__(140).f(Object.prototype, '__proto__').set, 2);
      set(test, []);
...
__webpack_require__(136)(IteratorPrototype, __webpack_require__(129)('iterator'), function () {
  return this;
});
...
var html = __webpack_require__(191);
var cel = __webpack_require__(187);
var global = __webpack_require__(126);
...
var isNode = __webpack_require__(143)(process) == 'process';
...
module.exports = !__webpack_require__(130) && !__webpack_require__(127)(function () {
  return Object.defineProperty(__webpack_require__(187)('div'), 'a', { get: function get() {
      return 7;
    } }).a != 7;
});
...
var ws = __webpack_require__(193);
var hex = /^[-+]?0[xX]/;
...
// 21.2.5.3 get RegExp.prototype.flags()
if (__webpack_require__(130) && /./g.flags != 'g') __webpack_require__(131).f(RegExp.prototype, 'flags', {
  configurable: true,
...
var each = __webpack_require__(150)(0);
var redefine = __webpack_require__(137);
var meta = __webpack_require__(153);
...
var $WeakMap = module.exports = __webpack_require__(182)(WEAK_MAP, wrapper, methods, weak, true, true);
...
var redefineAll = __webpack_require__(165);
var getWeak = __webpack_require__(153).getWeak;
var anObject = __webpack_require__(125);
var isObject = __webpack_require__(128);
var anInstance = __webpack_require__(163);
var forOf = __webpack_require__(164);
...
var gOPS = __webpack_require__(175);
var anObject = __webpack_require__(125);
var Reflect = __webpack_require__(126).Reflect;
...
var toLength = __webpack_require__(132);
var ctx = __webpack_require__(142);
var IS_CONCAT_SPREADABLE = __webpack_require__(129)('isConcatSpreadable');
...
var getKeys = __webpack_require__(158);
var toIObject = __webpack_require__(139);
var isEnum = __webpack_require__(171).f;
...
var $fails = __webpack_require__(127);
var shared = __webpack_require__(173);
var setToStringTag = __webpack_require__(166);
var uid = __webpack_require__(156);
var wks = __webpack_require__(129);
var wksExt = __webpack_require__(215);
...
$Symbol[PROTOTYPE][TO_PRIMITIVE] || __webpack_require__(136)($Symbol[PROTOTYPE], TO_PRIMITIVE, $Symbol[PROTOTYPE].valueOf);
...
$export($export.S + $export.F * !__webpack_require__(130), 'Object', { defineProperty: __webpack_require__(131).f });
...
$export($export.S + $export.F * !__webpack_require__(130), 'Object', { defineProperties: __webpack_require__(217) });
...
// 19.1.2.6 Object.getOwnPropertyDescriptor(O, P)
var toIObject = __webpack_require__(139);
var $getOwnPropertyDescriptor = __webpack_require__(140).f;
...
__webpack_require__(149)('getOwnPropertyNames', function () {
  return __webpack_require__(218).f;
});
...
var isObject = __webpack_require__(128);
var meta = __webpack_require__(153).onFreeze;
...
var classof = __webpack_require__(172);
var test = {};
test[__webpack_require__(129)('toStringTag')] = 'z';
if (test + '' != '[object z]') {
...
var isObject = __webpack_require__(128);
var getPrototypeOf = __webpack_require__(141);
var HAS_INSTANCE = __webpack_require__(129)('hasInstance');
var FunctionProto = Function.prototype;
// 19.2.3.6 Function.prototype[@@hasInstance](V)
if (!(HAS_INSTANCE in FunctionProto)) __webpack_require__(131).f(FunctionProto, HAS_INSTANCE, { value: function value(O) {
...
var BROKEN_COF = cof(__webpack_require__(160)(proto)) == NUMBER;
...
var $export = __webpack_require__(124);
var toInteger = __webpack_require__(148);
var aNumberValue = __webpack_require__(224);
var repeat = __webpack_require__(195);
...
$export($export.P + $export.F * (!!$toFixed && (0.00008.toFixed(3) !== '0.000' || 0.9.toFixed(0) !== '1' || 1.255.toFixed(2) !== '1.25' || 1000000000000000128.0.toFixed(0) !== '1000000000000000128') || !__webpack_require__(127)(function () {
  // V8 ~ Android 4.3-
  $toFixed.call({});
})), 'Number', {
...
var $export = __webpack_require__(124);
var _isFinite = __webpack_require__(126).isFinite;
...
var $export = __webpack_require__(124);
var isInteger = __webpack_require__(225);
var abs = Math.abs;
...
var $export = __webpack_require__(124);
var log1p = __webpack_require__(226);
var sqrt = Math.sqrt;
...
$export($export.S, 'Math', { fround: __webpack_require__(227) });
...
var $export = __webpack_require__(124);
var $at = __webpack_require__(198)(false);
...
var $export = __webpack_require__(124);
var toLength = __webpack_require__(132);
var context = __webpack_require__(201);
...
$export($export.P, 'String', {
  ...
  repeat: __webpack_require__(195)
});
...
var TO_PRIMITIVE = __webpack_require__(129)('toPrimitive');
var proto = Date.prototype;

if (!(TO_PRIMITIVE in proto)) __webpack_require__(136)(proto, TO_PRIMITIVE, __webpack_require__(334));
...
$export($export.S, 'Array', { isArray: __webpack_require__(176) });
...
$export($export.S + $export.F * !__webpack_require__(178)(function (iter) {
  Array.from(iter);
}), 'Array', {
...
$export($export.P + $export.F * (__webpack_require__(170) != Object || !__webpack_require__(144)(arrayJoin)), 'Array', {
  join: function join(separator) {
...
$export($export.P + $export.F * (fails(function () {
  ...
  test.sort(null);
  // Old WebKit
}) || !__webpack_require__(144)($sort)), 'Array', {
...
var $export = __webpack_require__(124);
var $forEach = __webpack_require__(150)(0);
var STRICT = __webpack_require__(144)([].forEach, true);
...
var $export = __webpack_require__(124);
var $map = __webpack_require__(150)(1);

$export($export.P + $export.F * !__webpack_require__(144)([].map, true), 'Array', {
...
var $export = __webpack_require__(124);
var $filter = __webpack_require__(150)(2);

$export($export.P + $export.F * !__webpack_require__(144)([].filter, true), 'Array', {
...
var $export = __webpack_require__(124);
var $some = __webpack_require__(150)(3);

$export($export.P + $export.F * !__webpack_require__(144)([].some, true), 'Array', {
...
var $export = __webpack_require__(124);
var $every = __webpack_require__(150)(4);

$export($export.P + $export.F * !__webpack_require__(144)([].every, true), 'Array', {
...
$export($export.P + $export.F * !__webpack_require__(144)([].reduce, true), 'Array', {
...
$export($export.P + $export.F * !__webpack_require__(144)([].reduceRight, true), 'Array', {
...
$export($export.P + $export.F * (NEGATIVE_ZERO || !__webpack_require__(144)($native)), 'Array', {
...
__webpack_require__(154)('copyWithin');
...
var gOPN = __webpack_require__(161).f;
var isRegExp = __webpack_require__(177);
var $flags = __webpack_require__(179);
...
if (__webpack_require__(130) && (!CORRECT_NEW || __webpack_require__(127)(function () {
  re2[__webpack_require__(129)('match')] = false;
...
__webpack_require__(162)('RegExp');
...
if (__webpack_require__(127)(function () {
...
__webpack_require__(182)(WEAK_SET, function (get) {
...
var toLength = __webpack_require__(132);
var isObject = __webpack_require__(128);
var ArrayBuffer = __webpack_require__(126).ArrayBuffer;
var speciesConstructor = __webpack_require__(181);
var $ArrayBuffer = buffer.ArrayBuffer;
var $DataView = buffer.DataView;
...
__webpack_require__(162)(ARRAY_BUFFER);
...
$export($export.G + $export.W + $export.F * !__webpack_require__(183).ABV, {
  DataView: __webpack_require__(212).DataView
});
...
__webpack_require__(151)('Int8', 1, function (init) {
...
__webpack_require__(151)('Uint8', 1, function (init) {
...
__webpack_require__(151)('Int16', 2, function (init) {
...
__webpack_require__(151)('Uint16', 2, function (init) {
...
__webpack_require__(151)('Int32', 4, function (init) {
...
__webpack_require__(151)('Uint32', 4, function (init) {
...
__webpack_require__(151)('Float32', 4, function (init) {
...
__webpack_require__(151)('Float64', 8, function (init) {
...
var aFunction = __webpack_require__(134);
var anObject = __webpack_require__(125);
var rApply = (__webpack_require__(126).Reflect || {}).apply;
...
var rConstruct = (__webpack_require__(126).Reflect || {}).construct;
...
__webpack_require__(154)('includes');
...
var $export = __webpack_require__(124);
var flattenIntoArray = __webpack_require__(242);
var toObject = __webpack_require__(133);
var toLength = __webpack_require__(132);
var aFunction = __webpack_require__(134);
...
__webpack_require__(154)('flatMap');
...
__webpack_require__(154)('flatten');
...
var $export = __webpack_require__(124);
var $pad = __webpack_require__(243);
...
__webpack_require__(200)($RegExpStringIterator, 'RegExp String', function next() {
...
var $export = __webpack_require__(124);
var $values = __webpack_require__(244)(false);
...
__webpack_require__(130) && $export($export.P + __webpack_require__(184), 'Object', {
...
$export($export.G, { global: __webpack_require__(126) });
...
var fround = __webpack_require__(227);
...
var metadata = __webpack_require__(152);
var anObject = __webpack_require__(125);
...
var $export = __webpack_require__(124);
var microtask = __webpack_require__(210)();
var process = __webpack_require__(126).process;
var isNode = __webpack_require__(143)(process) == 'process';
...
var core = __webpack_require__(145);
var microtask = __webpack_require__(210)();
var OBSERVABLE = __webpack_require__(129)('observable');
var aFunction = __webpack_require__(134);
var anObject = __webpack_require__(125);
var anInstance = __webpack_require__(163);
var redefineAll = __webpack_require__(165);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(213), __webpack_require__(449)(module)))
...
module.exports = __webpack_require__(145).RegExp.escape;
