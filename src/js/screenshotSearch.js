  ...
  function(request, sender, sendResponse) {
    ...
    if ('job' in request) {
      if (request.job == 'screenshotSearch') {
        ...
        img.onload = function() {
          div.append('<div class="NooBox-screenshot-search" style="' + defautlCSS + 'cursor:pointer;box-sizing:content-box;height:29px;width:29px;position:absolute;z-index:3;float:right;background-color:rgba(130, 186, 255, 0);"><svg viewBox="0 0 300 300" width="300" height="300" xmlns="http://www.w3.org/2000/svg"> <g> <ellipse stroke="#000" ry="87" rx="86" id="svg_1" cy="121.999997" cx="123.000003" stroke-width="25" fill="#000000" fill-opacity="0"/> <line stroke="#000" stroke-linecap="null" stroke-linejoin="null" id="svg_3" y2="267.499998" x2="251.500004" y1="193.5" x1="185.5" stroke-opacity="null" stroke-width="30" fill="none"/> </g></svg></div>');
          ...
          div.append('<div class="NooBox-screenshot-close" style="' + defautlCSS + 'position:absolute;z-index:3;cursor:pointer;user-select: none;width: 29px;height: 29px;font-size: 30px;text-align: center;line-height:0px;background: rgba(193, 22, 59, 0);"><svg viewBox="0 0 300 300" width="300" height="300" xmlns="http://www.w3.org/2000/svg"> <g> <line stroke="#000" stroke-linecap="null" stroke-linejoin="null" id="svg_3" y2="250" x2="250" y1="50" x1="50" stroke-opacity="null" stroke-width="30" fill="none"/> <line stroke="#000" transform="rotate(-90 142.00000000000003,148.5) " stroke-linecap="null" stroke-linejoin="null" id="svg_5" y2="250" x2="250" y1="50" x1="50" stroke-opacity="null" stroke-width="30" fill="none"/> </g></svg></div>');
          ...
          $('body').append(div);
          $('body').append('<style>#NooBox-screenshot svg{width: 100%;height: 100%;}@keyframes shiny{0%{background-color:grey}50%{background-color:black}100%{background-color:grey}} .NooBox-shiny{animation: shiny 3s infinite}</style>');
