...
export const imageSearchUpdateDisplayMode = createAction(
  'imageSearch/updateDisplayMode',
);
export const imageSearchSortBy = createAction('imageSearch/updateSortBy');
export const imageSearchSoryByOrder = createAction(
  'imageSearch/updateSortByOrder',
);
