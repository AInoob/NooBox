...
const gridOptions = [
  { keys: ['google', 'googleDone'], src: google, id: 'google' },
  { keys: ['baidu', 'baiduDone'], src: baidu, id: 'baidu' },
  { keys: ['yandex', 'yandexDone'], src: yandex, id: 'yandex' },
  { keys: ['bing', 'bingDone'], src: bing, id: 'bing' },
  { keys: ['tineye', 'tineyeDone'], src: tineye, id: 'tineye' },
  { keys: ['saucenao', 'saucenaoDone'], src: saucenao, id: 'saucenao' },
  { keys: ['iqdb', 'iqdbDone'], src: iqdb, id: 'iqdb' },
  { keys: ['ascii2d', 'ascii2dDone'], src: ascii2d, id: 'ascii2d' },
];
