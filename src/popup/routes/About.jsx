          ...
          <Collapse defaultActiveKey={['3']}>
            ...
            <Panel header={i18n('about_data')} key="3">
              ...
              <ul id="realTimeDataList">
                <li>
                  {i18n('imageSearch')} :{' '}
                  <span className="data">{about.imageSearch}</span>
                </li>
                <li>
                  {i18n('extractImages')} :{' '}
                  <span className="data">{about.extractImage}</span>
                </li>
                <li>
                  {i18n('screenshotSearch')} :{' '}
                  <span className="data">{about.screenshotSearch}</span>
                </li>
                <li>
                  {i18n('videoControl')} :{' '}
                  <span className="data">{about.videoControl}</span>
                </li>
                <li>
                  {i18n('autoRefresh')} :{' '}
                  <span className="data">{about.autoRefresh}</span>
                </li>
              </ul>
            </Panel>
